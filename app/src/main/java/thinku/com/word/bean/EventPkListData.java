 ...
 */
    ...
    public  class EventPkListData implements Parcelable {
        /**
         * totalId : 141
    ...
    protected EventPkListData(Parcel in) {
        totalId = in.readInt();
        words = new ArrayList<>();
        in.readTypedList(words ,WordsBean.CREATOR);
    }

    public static final Creator<EventPkListData> CREATOR = new Creator<EventPkListData>() {
        @Override
        public EventPkListData createFromParcel(Parcel in) {
            return new EventPkListData(in);
        }

        @Override
        public EventPkListData[] newArray(int size) {
            return new EventPkListData[size];
        }
    };
