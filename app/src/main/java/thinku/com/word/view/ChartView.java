...
public class ChartView extends View {
    ...
    //x轴各个坐标点水平间距
    private int interval = dpToPx(100);
    //背景颜色
    ...
    private void initPaint(Context context) {
        ...
        Paint1.setColor(context.getResources().getColor(R.color.color_paint1));
        Paint2.setColor(context.getResources().getColor(R.color.color_paint2));
        paint3.setColor(context.getResources().getColor(R.color.color_paint3));
        paint4.setColor(context.getResources().getColor(R.color.color_paint4));
        paint5.setColor(context.getResources().getColor(R.color.color_paint5));

        paints = new ArrayList<>();
        paints.add(Paint1); paints.add(Paint2); paints.add(paint3); paints.add(paint4); paints.add(paint5);
    }
...
//            //X轴文本最大高度
    ...
    public void setValue(Map<String, List<Integer>> value) {
        this.value = value;
        invalidate();
    }

    public void setValue(Map<String, List<Integer>> value, List<String> xValue, List<Integer> yValue) {
        this.value = value;
        this.xValue = xValue;
        this.yValue = yValue;
        invalidate();
    ...
    public Map<String, List<Integer>> getValue() {
        return value;
    }
