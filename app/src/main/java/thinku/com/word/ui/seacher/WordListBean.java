...
public class WordListBean implements Parcelable {
    ...
    private List<RecitWordBeen.LowSentenceBean> sentence;
    private List<RecitWordBeen.LowSentenceBean> lowSentence;
    protected WordListBean(Parcel in) {
    ...
    public static final Creator<WordListBean> CREATOR = new Creator<WordListBean>() {
        @Override
        public WordListBean createFromParcel(Parcel in) {
            return new WordListBean(in);
        }

        @Override
        public WordListBean[] newArray(int size) {
            return new WordListBean[size];
        }
    };
    ...
    public List<RecitWordBeen.LowSentenceBean> getSentence() {
        return sentence;
    }

    public void setSentence(List<RecitWordBeen.LowSentenceBean> sentence) {
        this.sentence = sentence;
    }

    public List<RecitWordBeen.LowSentenceBean> getLowSentence() {
        return lowSentence;
    }

    public void setLowSentence(List<RecitWordBeen.LowSentenceBean> lowSentence) {
